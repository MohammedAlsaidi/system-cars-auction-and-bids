...
Route::group(['prefix' => 'dashboard', 'middleware' => ['role:superadministrator|dealer|administrator|checkup'], 'verified'], function () {

    Route::get('/', 'AdminController@index')->name('dashboard');

    Route::group(['prefix' => 'mange', 'middleware' => ['role:superadministrator']], function () {
    ...
    Route::group(['prefix' => 'notifications'], function () {
        ...
        Route::get('readallnotify', 'NotificationContr0oller@markAsReadAll')->name('readAllNotify');
    ...
    Route::group(['prefix' => 'users'], function () {
        ...
        Route::get('contact-user/{id}', 'AdminController@destroy')->name('admin.users.contact.delete');
...
Route::group(['prefix' => 'auctions', 'middleware' => ['role:superadministrator|administrator']], function () {
    Route::get('/', 'AuctionController@index')->name('auction.index');
    Route::get('create', 'AuctionController@create')->name('auction.create');
    Route::post('store', 'AuctionController@store')->name('auction.store');
    Route::get('edit/{auction}', 'AuctionController@edit')->name('auction.edit');
    Route::post('update/{auction}', 'AuctionController@update')->name('auction.update');
    Route::get('destroy/{auction}', 'AuctionController@destroy')->name('auction.destroy');
});
