...
class ModelController extends Controller
{
    ...
    {
        $this->middleware('permission:delete-mdoel')->only('destroy');
    }
    ...
    public function store(ModelRequest $request)
    {
        try {
            ...
            return redirect()->route('admin.models')->with(['success' => __('Success Save')]);
    ...
    public function update(ModelRequest $request, $id)
    {
        try {
            ...
            return redirect()->route('admin.models')->with(['success' => __('Success Update')]);
        } catch (Exception $ex) {
