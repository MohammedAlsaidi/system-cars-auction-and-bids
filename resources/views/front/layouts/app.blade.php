            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="{{route('cars.index')}}" role="button"
                           aria-haspopup="true" aria-expanded="false">Cars</a>
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="{{route('cars.filter', 1 )}}">New Cars</a>
                            <a class="dropdown-item         " href="{{route('cars.filter', 0 )}}">Old Cars</a>
                        </div>
                    </li>
                ...
                <div class="col-md-6">
                    ...
                    <div class="left-content">
                        ...
                        <p>
                            ...
                            <strong>
                                <a href="tel:123-456-789">2802729</a>
                            </strong>
                        </p>
                        ...
                        <p>
                            ...
                            <strong>
                                <a href="tel:456789123">0599-7753-901</a>
                            </strong>
                        </p>
                        ...
                        <p>
                            ...
                            <strong>
                                <a href="mailto:john@carsales.com">mohammedsaidi@gmail.com</a>
                            </strong>
                        </p>
                    </div>
                </div>
